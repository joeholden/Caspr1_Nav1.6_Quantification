...
def get_data(channel, img_path, roi_number):
    ...
    integer_coordinates = [list(c) for c in integer_coordinates]
    map_coordinates = [(i+left, j+top) for [i, j] in integer_coordinates]
    x1 = map_coordinates[0][0]
    y1 = map_coordinates[0][1]
    x2 = map_coordinates[1][0]
    y2 = map_coordinates[1][1]

    try:
        x3 = map_coordinates[2][0]
        y3 = map_coordinates[2][1]
    except IndexError:
        pass

    try:
        x4 = map_coordinates[3][0]
        y4 = map_coordinates[3][1]
    except IndexError:
        pass
